...
/// UI-03A migrou `AppPrimaryButton`/`AppTextField` para cá).
///
/// Todos os componentes-base agora vivem em `design_system/components/`
/// — `core/widgets/` foi removido (UI-03A, Component Migration).
library;
...
export 'feedback/app_animated_switcher.dart';
